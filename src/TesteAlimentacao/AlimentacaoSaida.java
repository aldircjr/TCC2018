...
public class AlimentacaoSaida {
    ...
    public AlimentacaoSaida(String data, int id, int quantidade, float preco, Usuario usuario) {
        this.data = data;
        this.idProduto = id;
    ...
    public void enviaMovimentacao() throws IOException, ParseException{
        ...
        Movimentacao movimentacao = new Movimentacao(this.quantidade, this.tipo, this.produto, this.usuario, (float) 0.0);
